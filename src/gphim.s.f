...
c-----------------------------------------------------------------------
     ...
     *  phi,iord)
      ...
      integer dp
      parameter (dp = 16)
      real(dp) angle,rp(3,np),cm(np),rpi(3),cmi,cmimin,cmimax,tol,
     *  phi(2,np)
c
c        parameters
      include 'pi.par'
